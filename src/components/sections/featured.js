...
const Featured = () => {
  ...
  const projectImages = data.images.edges.reduce((acc, { node }) => {
  ...
  const projects = [
    ...
    },
    {
      ...
      github: 'https://github.com/ChetanAditya765/Autism-Prediction',
      image: 'autism.jpg',
    },
    {
      title: 'Essay Grading',
      description:
        'Developing a machine learning system for essay grading, assessing coherence, organization, grammar, and relevance to the prompt, enhancing efficiency and objectivity in educational assessment.',
      tech: ['Python', 'Machine Learning'],
      github: 'https://github.com/ChetanAditya765/Essay-Grading-Framework',
      image: 'essay.jpg',
    },
    {
